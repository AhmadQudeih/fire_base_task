...
class TaskDetials extends StatefulWidget {
  const TaskDetials({super.key});

  @override
  State<TaskDetials> createState() => _TaskDetialsState();
}

class _TaskDetialsState extends State<TaskDetials> {
  @override
    ...
    return Scaffold(
      ...
      body: Directionality(
        ...
        child: Container(
          ...
          margin: EdgeInsets.symmetric(horizontal: 27, vertical: 37),
          child: Column(
            ...
            children: [
              ...
              Stack(
                children: [
                  ...
                  Positioned(
                    top: 26,
                    left: 0,
                    child: SvgPicture.asset('assets/icons/Ellipse 72.svg'),
                  ),
                ],
              ),
              ...
              // الطلاب الذين قامو بتسليم المهمة
              Container(
