...
import 'package:task/fireBase/fireBaseOuth.dart';
...
class _signUpState extends State<signUp> {
  ...
  signUp() {
    FireBaseOuthController fireBaseOuth = FireBaseOuthController();
    fireBaseOuth.signUp(email: email.text, password: password.text);
  }
}
